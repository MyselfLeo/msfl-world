...
namespace wrld::rsc {
    ...
    //
    //         // Load the textures
    //         const auto diffuse_textures = load_textures(
    //                 ai_material, aiTextureType_DIFFUSE, scene, flip_textures, 1);
    //         const auto specular_textures = load_textures(
    //                 ai_material, aiTextureType_SPECULAR, scene, flip_textures, 1);
    //
    ...
    // const std::shared_ptr<MeshGraphNode> &Model::get_root_mesh() const {
    //     return root_mesh;
    // }

    // const std::vector<Rc<Material>> &Model::get_materials() const {
    //     return loaded_materials;
    // }

    // const std::vector<unsigned int> &
    // Model::get_material_meshes(const std::string &mat_name) const {
    ...
    //
    // const obj::Box &Model::get_local_bb() const { return local_bb; }

    // const std::vector<GLenum> &Model::get_primitive_types() const { return
    // primitive_types; }
    ...
    //
    // std::shared_ptr<MeshGraphNode> Model::process_node(const aiNode *node,
    //                                                    const aiScene *scene) {
