...
namespace wrld {
    DeferredRendererSystem::DeferredRendererSystem(World &world, GLFWwindow *window) : RendererSystem(world, window) {
        ...
        pass1.get_mut()->set_shader("wrld/shaders/vertex/default.glsl", "wrld/shaders/fragment/deferred_pass1.glsl");
        pass1_program = pass1;

        const auto pass2 = world.create_resource<rsc::Program>("pass2_program");
        pass2.get_mut()->set_shader("wrld/shaders/deferred_pass2.glsl");
        pass2_program = pass2;
